...
# Método de Heun
def heun(y0, t_end, h, k, iterations):
    t = 0
    y = y0
    values = []
...
# # Calcular para h = 0.5
# result_h_0_5 = heun(y0, t_end, h_values[0], k, iterations)
# print(f"Últimos três valores do nível do tanque para h = 0.5: {result_h_0_5}")

# # Calcular para h = 0.25
# result_h_0_25 = heun(y0, t_end, h_values[1], k, iterations)
# print(f"Últimos três valores do nível do tanque para h = 0.25: {result_h_0_25}")

# Calcular para h = 0.5 e imprimir com 5 casas decimais
result_h_0_5 = heun(y0, t_end, h_values[0], k, iterations)
result_h_0_5_formatted = [f"{value:.5f}" for value in result_h_0_5]
print(f"Últimos três valores do nível do tanque para h = 0.5: {result_h_0_5_formatted}")

# Calcular para h = 0.25 e imprimir com 5 casas decimais
result_h_0_25 = heun(y0, t_end, h_values[1], k, iterations)
result_h_0_25_formatted = [f"{value:.5f}" for value in result_h_0_25]
print(f"Últimos três valores do nível do tanque para h = 0.25: {result_h_0_25_formatted}")
