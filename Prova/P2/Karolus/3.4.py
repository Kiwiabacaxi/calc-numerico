...
def heun_method(dydt, t0, y0, h, iterations, tol=1e-6, max_iter=10):
    t_values = np.arange(t0, t0 + h * (iterations + 1), h)
...
for h in h_values:
    ...
    t_values, y_values = heun_method(dydt, 0, y0, h, iterations)
