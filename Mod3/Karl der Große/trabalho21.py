...
usando o método de Heun sem iteração. O programa deverá permitir a escolha de h. Verifique os resultados com h = 0,25 e o intervalo para t de 0 a 4.
"""
...
def heun_method(dydt, t0, y0, h, t_end):
...
# Resolvendo a EDO usando o método de Heun
